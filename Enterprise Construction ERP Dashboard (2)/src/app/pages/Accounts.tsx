...
export default function Accounts() {
  ...
  const totalExpense = plData.filter(item => item.type === "Expense").reduce((sum, item) => sum + item.amount, 0)
            ...
            <CardContent>
              <div className="rounded-md border overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {plData.filter(item => item.type === "Income").map((item) => (
                    ...
                    {plData.filter(item => item.type === "Expense").map((item) => (
                      <TableRow key={item.id}>
                        <TableCell className="text-xs">
            ...
            <CardContent>
              ...
              <div className="mt-4 flex items-center justify-center gap-8">
                <div className="text-center">
                  ...
                  <p className="text-2xl text-green-600 dark:text-green-400">₹515L</p>
                </div>
              </div>
            </CardContent>
          </Card>
